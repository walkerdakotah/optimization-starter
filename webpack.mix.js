...
mix.setResourceRoot(`/wp-content/themes/${config.publicPath}/`);
/*
 |--------------------------------------------------------------------------
...
// mix.js(src, output);
mix.js(`${config.sourcePath}/optimization/app.js`, `${config.publicPath}/js/custom.js`);
// mix.sass(src, output);
mix.sass(`${config.sourcePath}/optimization/app.scss`, `${config.publicPath}/*_custom.scss`).options({
...
mix.browserSync({
  ...
  proxy: config.site,
  open: 'external',
  files: ['**/*.css', `${config.publicPath}/js/custom.js`, `${config.publicPath}/*_custom.scss`]
});
